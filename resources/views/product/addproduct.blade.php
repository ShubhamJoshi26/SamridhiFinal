...
<div class="body d-flex py-3">
                <div class="container-xxl">
                    ...
                    <form  id="productform" method="post" enctype="multipart/form-data" action="/Product/CreateProduct">
                        @csrf
                        <input type="hidden" id="id" name="id" value="@if(isset($product)){{$product['id']}}@endif">
                                ...
                                <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" required name="product_price" id="product_price" value="@if(isset($product)){{$product['price']}}@endif">
                                                    
                                                </div>
                                                <!-- <div class="col-md-12">
                                                    <label  class="form-label">Product Type</label>
                                                    <select type="text" class="form-control" name="product_type" id="product_type">
                                                        <option value="">Product Type</option>
                                                    </select>
                                                </div> -->
                                                <div class="col-md-12">
                                                    <label  class="form-label">Product Coupon</label>
                                                    <select type="text" class="form-control" name="product_coupon" id="product_coupon">
                                                    <option value="0" @if(isset($product) && $product['coupons']==0){{$selected}}@endif>Select Category</option>
                                                @if(isset($coupon))
                                                    @foreach($coupon as $couponlist)
                                                        
                                                        <option value="{{$couponlist['id']}}" @if(isset($coupon) && isset($product) && $couponlist['id']==$product['coupons']){{$selected}}@endif>{{$couponlist['name']}}</option>
                                                    @endforeach
                                                @endif
                                                    </select>
                                                </div>
                                    ...
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <select class="form-select" aria-label="size 3 select example" required name="product_category" id="product_category">
                                            <option value="0" @if(isset($product) && $product['category']==0){{$selected}}@endif>Select Category</option>
                                                @if(isset($category))
                                                    @foreach($category as $cat)
                                                        
                                                        <option value="{{$cat['id']}}" @if(isset($product) && $product['category']==$cat['id']){{$selected}}@endif>{{$cat['category_name']}}</option>
                                                    @endforeach
                                                @endif

                                                <!-- <option value="0" @if(isset($product) && $product['category']==0){{$selected}}@endif>Select Category</option>
                                                <option value="1" @if(isset($product) && $product['category']==1){{$selected}}@endif>Watch</option>
                                                <option value="2" @if(isset($product) && $product['category']==2){{$selected}}@endif>Clothes</option>
                                                <option value="3" @if(isset($product) && $product['category']==3){{$selected}}@endif>Toy</option>
                                                <option value="4" @if(isset($product) && $product['category']==4){{$selected}}@endif>Cosmetic</option>
                                                <option value="5" @if(isset($product) && $product['category']==5){{$selected}}@endif>Laptop</option>
                                                <option value="6" @if(isset($product) && $product['category']==6){{$selected}}@endif>Mobile</option>
                                                <option value="7" @if(isset($product) && $product['category']==7){{$selected}}@endif>Gaming accessories</option> -->
                                            </select>
                                        </div>
                                    </div>
                                    <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-check">
                                                <select name="visibility" id="visibility" class="form-control" required name="product_visibility" id="product_visibility">
                                                    <option value="0" @if(isset($product) && $product['visibility']==0){{$selected}}@endif>Select Visibility</option>
                                                    <option value="1" @if(isset($product) && $product['visibility']==1){{$selected}}@endif>Yes</option>
                                                    <option value="2" @if(isset($product) && $product['visibility']==2){{$selected}}@endif>No</option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="card-body">
                                            <div class="row g-3 align-items-center">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="text" class="form-control" name="product_sku" id="product_sku" value="@if(isset($product)){{$product['sku']}}@endif">
                                                </div>
                                                <div class="col-md-12">
                                                    <label  class="form-label">Total Stock Quantity</label>
                                                    <input type="text" class="form-control" required name="product_inventory" id="product_inventory" value="@if(isset($product)){{$product['inventory']}}@endif">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                            ...
                                            <div class="row g-3 align-items-center">
                                                <div class="col-md-6">
                                                    ...
                                                    <input type="text" class="form-control" required name="product_name" id="product_name" value="@if(isset($product)){{$product['name']}}@endif">
                                                </div>
                                                <div class="col-md-6">
                                                    <label  class="form-label">Page Title</label>
                                                    <input type="text" class="form-control" name="product_title" id="product_title" value="@if(isset($product)){{$product['title']}}@endif">
                                                </div>
                                                <!-- <div class="col-md-12">
                                                ...
                                                <div class="col-md-12">
                                                    ...
                                                    <div id="editor">
                                                        <textarea name="product_description" required id="product_description" cols="30" rows="" class="form-control">@if(isset($product)){{$product['description']}}@endif</textarea>
                                                    </div>
                                                </div>
                                            </div>
                                ...
                                <div class="mb-3 row">
                                    @if(isset($images))
                                        @foreach($images as $image)
                                            ...
                                            <img src="{{URL::asset($image['image_path'])}}" alt="" style="    width: 240px;
    height: 150px;margin-left:4px;margin-top:20px;"><button class="closes" type="button" title="Delete" onclick="DeleteProductImage({{$image['id']}})">×</button></img>
                                            </div>
                                        @endforeach
                                    @endif
                                </div>
                                            ...
                                            <!-- <div class="row g-3 align-items-center">
                                                <div class="col-md-12">
                                                    ...
                                                    <input type="file" id="input-file-to-destroy" class="dropify"  data-max-file-size="2M" data-max-height="2000" multiple>
                                                </div> -->
                                ...
                                <!-- <div class="card mb-3">
                                        ...
                                        <div class="card-body">
                                            <div class="form-group demo-tagsinput-area">
                                                <div class="form-line">
                                                    <input type="text" class="form-control" data-role="tagsinput" name="product_tags" id="product_tags">
                                                </div>
                                            </div>
                                        </div>
                                    </div> -->
