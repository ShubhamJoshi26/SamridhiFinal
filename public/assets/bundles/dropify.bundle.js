    ...
    return (
        ...
        (e.prototype.onFileReady = function (i, e, t) {
            if (
                ...
                for (
                    var s, r = this.errorsEvent.errors.length - 1;
                    0 <= r;
                    r--
                ) {
                    var n = this.errorsEvent.errors[r].namespace
                        .split(".")
                        .pop();
                    this.showError(n);
                }
                ...
                (!0 === i
                    ? ((i = o("<img />").attr("src", e)),
                      this.settings.height &&
                          i.css("max-height", this.settings.height),
                      i)
                    : (o("<i />")
                          .attr("class", "dropify-font-file")
                          .appendTo(t),
                      o('<span class="dropify-extension" />').html(
                          this.getFileType()
                      ))
                ).appendTo(t),
                this.preview.fadeIn();
            ...
            0 === this.errorsEvent.errors.length
                ? ((i = o.Event("dropify.beforeClear")),
                  ...
                  !1 !== i.result &&
                      ...
                      this.input.val(""),
                      this.resetPreview(),
                      this.input.trigger(o.Event("dropify.afterClear"), [
                          this,
                      ])))
